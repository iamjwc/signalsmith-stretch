...
There's a Web Audio release in [`web/`](web/) (WASM/AudioWorklet, TypeScript bindings), also available on [NPM](https://www.npmjs.com/package/signalsmith-stretch). It exposes typed helpers for scheduling, buffer management, and latency reporting while staying in sync with the C++ core.
